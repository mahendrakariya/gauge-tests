...
public class SpecificationBuilder {
    ...
    public void buildAndAddToProject() throws Exception {
        Specification spec = GaugeProject.getCurrentProject().findSpecification(specName);
        if (spec == null) {
            spec = GaugeProject.getCurrentProject().createSpecification(subDirPath, specName);
        }
    ...
    public SpecificationBuilder withScenarioDataStoreWriteStatement(String key, String value) {
        ...
        GaugeProject.getCurrentProject().getDataStoreWriteStatement(row, columns);
        return this;
    }

    public SpecificationBuilder withDataStoreWriteStatement(List<String> columnNames, TableRow row) {
        scenarioBuilder.addSteps(columnNames, row.getCell("step text"), GaugeProject.getCurrentProject().getDataStoreWriteStatement(row, columnNames));
        return this;
    }

    public SpecificationBuilder withDataStorePrintValues(List<String> columnNames, TableRow tableRow) {
        scenarioBuilder.addSteps(columnNames, tableRow.getCell("step text"), GaugeProject.getCurrentProject().getDataStorePrintValueStatement(tableRow, columnNames));
        return this;
    }
